...
<html lang="es">
    ...
    <body>
        ...
        <div class="container-xl mt-5 text-center">
            <h1 class="m-4 display-2">Modificar registro</h1>
            <div>
                <p><span>Id_Libro: </span> <?php
                    $id_libro = $_POST['Id_libro'];
                    echo $id_libro;                
                    ?>
                </p>
                <p><span>Id_Biblioteca: </span> <?php
                    $id_biblioteca = $_POST['Id_biblioteca'];
                    echo $id_biblioteca;
                    ?>
                </p>
                <p><span>Disponibilidad: </span> <?php
            ...
            <form method="POST">
                <?php 
                    FormUpdateBookLibraries($cadenaConexion,$id_libro,$id_biblioteca,$titulo);
                ?>
            </form>
        </div>
